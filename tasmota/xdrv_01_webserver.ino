...
const char HTTP_END[] PROGMEM =
  "<div style='text-align:right;font-size:11px;'><hr/><a href='https://bit.ly/tasmota' target='_blank' style='color:#aaa;'>Tasmota %s " D_BY " Theo Arends Modified " D_BY " Yannis Rosso</a></div>"
  "</div>"
  "</body>"
  "</html>";
